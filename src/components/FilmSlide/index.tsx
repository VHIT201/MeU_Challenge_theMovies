...
const FilmSlide: React.FC<FilmSlideProps> = ({
    ...
    return (
        <div className={cn('swiper-slide')} ref={slideRef} style={{ width: '100%' }}>
            <div
            ...
            >
                ...
                <div className={cn('container mx-auto z-10 h-fit flex items-center justify-between')}>
                    <div className={cn('w-full lg:w-2/3 flex flex-col items-start ')}>
                        <h2
                            className={cn(
                                'font-bold text-4xl text-white [text-shadow:_0_4px_4px_#999999] md:text-6xl lg:text-8xl animated text-left',
                            )}
                        >
                            {title}
                        </h2>
