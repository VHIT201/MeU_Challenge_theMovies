...
const RakingPage = () => {
    ...
    return (
        <main
            className={cn(
                isDarkMode && 'dark',
                'w-full flex flex-col items-center justify-start bg-white-main dark:bg-black-main',
            )}
        >
            <div
                className={cn(
            ...
            <div className="bg-white-main dark:bg-black-main w-full px-4 md:px-8 py-8 xl:p-16 space-y-16">
